...
public class KomgaService {
    ...
    public java.time.Instant getBookLastModified(Long bookId) {
    ...
    public List<KomgaPageDto> getBookPages(Long bookId) {
        ...
        boolean isCBX = book.getPrimaryBookFile() != null && 
                        (book.getPrimaryBookFile().getBookType() == org.booklore.model.enums.BookFileType.CBZ || 
                         book.getPrimaryBookFile().getBookType() == org.booklore.model.enums.BookFileType.CBR);
        
        List<org.booklore.model.dto.response.CbxPageDimension> dimensions = null;
        ...
        if (pageCount > 0) {
            for (int i = 1; i <= pageCount; i++) {
                ...
                if (dimensions != null && i - 1 < dimensions.size()) {
                    org.booklore.model.dto.response.CbxPageDimension dim = dimensions.get(i - 1);
