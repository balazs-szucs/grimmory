...
export const routes: Routes = [
  ...
  {path: 'oauth2-callback', component: OidcCallbackComponent},
  {
    ...
    children: [
      {path: 'dashboard', loadComponent: () => import('./features/dashboard/components/main-dashboard/main-dashboard.component').then(m => m.MainDashboardComponent), canActivate: [AuthGuard], data: {preload: true}},
      {path: 'all-books', loadComponent: loadBookBrowserComponent, canActivate: [AuthGuard], data: {preload: true}},
      {path: 'settings', loadComponent: () => import('./features/settings/settings.component').then(m => m.SettingsComponent), canActivate: [AuthGuard]},
      {path: 'library/:libraryId/books', loadComponent: loadBookBrowserComponent, canActivate: [AuthGuard], data: {preload: true}},
      {path: 'shelf/:shelfId/books', loadComponent: loadBookBrowserComponent, canActivate: [AuthGuard], data: {preload: true}},
      {path: 'unshelved-books', loadComponent: loadBookBrowserComponent, canActivate: [AuthGuard], data: {preload: true}},
      {path: 'series', loadComponent: () => import('./features/series-browser/components/series-browser/series-browser.component').then(m => m.SeriesBrowserComponent), canActivate: [AuthGuard], data: {preload: true}},
      ...
      {path: 'authors', loadComponent: () => import('./features/author-browser/components/author-browser/author-browser.component').then(m => m.AuthorBrowserComponent), canActivate: [AuthGuard], data: {preload: true}},
      ...
      {path: 'magic-shelf/:magicShelfId/books', loadComponent: loadBookBrowserComponent, canActivate: [AuthGuard], data: {preload: true}},
